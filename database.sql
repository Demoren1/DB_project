...
CREATE TABLE IF NOT EXISTS Driver (
    ...
    FOREIGN KEY (car_number) REFERENCES Car(num)
);
...
CREATE TABLE IF NOT EXISTS Client (
  ...
  card_number INT REFERENCES Loyalty_card(card_number),
  full_name VARCHAR(255) NOT NULL,
  phone_number VARCHAR(32) NOT NULL,
...
CREATE TABLE IF NOT EXISTS Ord (
  ...
  ID_user INTEGER REFERENCES Client(ID_user),
  ID_driver INTEGER REFERENCES Driver(ID_driver),
  car_number VARCHAR(16) REFERENCES Car(num),
  tariff_name VARCHAR(64) REFERENCES Tariff(tf_name),
...
CREATE TABLE IF NOT EXISTS Payment (
  ...
  ID_order INTEGER REFERENCES Ord(ID_ord),
  total_payment decimal(10, 2) NOT NULL,
  pay_date DATE NOT NULL,
  payment_method VARCHAR(50) NOT NULL
);

INSERT INTO Tariff (tf_name, price_for_km, basic_cost, modifier)
VALUES
('Эконом', 70, 50, 1),
('Стандарт', 100, 60, 1),
('Премиум', 200, 100, 2),
...
INSERT INTO Car (num, model, cond) VALUES
...
INSERT INTO Driver (ID_driver, car_number, full_name, phone_number, basic_fee, email, start_date) VALUES
...
INSERT INTO Driver (ID_driver, car_number, full_name, phone_number, basic_fee, email, start_date, end_date, is_current) VALUES
...
INSERT INTO Loyalty_card (card_number, bonus, create_date) VALUES
(1001, 500, '2023-01-01'),
(1002, 750, '2023-02-05'),
(1003, 300, '2023-03-10'),
...
INSERT INTO Client (ID_user, card_number, full_name, phone_number, email) VALUES
...
INSERT INTO Ord (ID_ord, ID_user, ID_driver, car_number, tariff_name, start_address, end_address, start_time, end_time, status) VALUES
(1, 1, 1, 'ABC123', 'Стандарт', 'Улица Пушкина, 10', 'Улица Гагарина, 15', '2024-01-01 08:00:00', '2024-01-01 10:00:00', 'Завершен'),
(2, 2, 2, 'DEF456', 'Премиум', 'Проспект Ленина, 25', 'Площадь Революции, 5', '2024-02-05 09:00:00', '2024-02-05 11:30:00', 'Завершен'),
(3, 3, 3, 'GHI789', 'Эконом', 'Улица Маяковского, 30', 'Бульвар Пушкина, 20', '2024-03-10 10:30:00', '2024-03-10 12:45:00', 'Завершен'),
(4, 4, 4, 'JKL101', 'Стандарт', 'Проспект Гагарина, 45', 'Улица Лермонтова, 12', '2024-04-15 11:45:00', '2024-04-15 14:00:00', 'Завершен'),
(5, 5, 5, 'MNO234', 'Премиум', 'Бульвар Ленина, 55', 'Проспект Революции, 30', '2024-05-20 12:30:00', '2024-05-20 15:15:00', 'Завершен'),
(6, 6, 6, 'PQR567', 'Эконом', 'Улица Гоголя, 70', 'Проспект Маяковского, 35', '2024-06-25 13:45:00', '2024-06-25 16:30:00', 'Завершен'),
(7, 7, 7, 'STU890', 'Стандарт', 'Площадь Пушкина, 80', 'Улица Горького, 40', '2024-07-30 15:00:00', '2024-07-30 18:00:00', 'Завершен'),
(8, 8, 8, 'VWX123', 'Премиум', 'Бульвар Чехова, 95', 'Площадь Чехова, 50', '2024-08-05 16:30:00', '2024-08-05 19:45:00', 'Завершен'),
(9, 9, 9, 'YZA456', 'Эконом', 'Проспект Достоевского, 110', 'Бульвар Достоевского, 60', '2024-09-10 18:00:00', '2024-09-10 21:00:00', 'Завершен'),
(10, 10, 10, 'IJK890', 'Стандарт', 'Улица Толстого, 125', 'Площадь Толстого, 70', '2024-10-15 19:30:00', '2024-10-15 22:30:00', 'Завершен'),
(11, 11, 11, 'BCD789', 'Премиум', 'Проспект Горького, 140', 'Улица Чехова, 80', '2024-11-20 21:00:00', '2024-11-20 23:45:00', 'Завершен'),
(12, 12, 12, 'CDE101', 'Эконом', 'Бульвар Лермонтова, 155', 'Площадь Лермонтова, 90', '2024-12-25 22:30:00', '2024-12-25 23:00:00', 'Завершен'),
(13, 13, 13, 'EFG234', 'Стандарт', 'Улица Чехова, 170', 'Бульвар Чехова, 100', '2025-01-01 00:00:00', '2025-01-01 03:00:00', 'Завершен'),
(14, 14, 14, 'GHI567', 'Премиум', 'Площадь Достоевского, 185', 'Улица Достоевского, 110', '2025-02-05 01:30:00', '2025-02-05 04:15:00', 'Завершен'),
(15, 15, 15, 'KLM123', 'Эконом', 'Бульвар Толстого, 200', 'Проспект Толстого, 120', '2025-03-10 03:00:00', '2025-03-10 03:30:00', 'Завершен');

INSERT INTO Payment (ID_payment, card_number, ID_order, total_payment, pay_date, payment_method) VALUES
